      ...
      <div className="w-full md:w-4/5 flex flex-row justify-between items-center">
        {icons &&
          icons.map((icon, index) => (
            <div className="relative w-10 h-10 md:w-20 md:h-20 rounded lg:rounded-xl hover:drop-shadow-xl transition duration-400 ease-in-out hover:-translate-y-1 hover:scale-110 flex flex-col items-center font-mono">
              <img
